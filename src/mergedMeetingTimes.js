...
function mergeRanges(meetings) {
  ...
  // create copy of original array of objects
  const meetingsCopy = JSON.parse(JSON.stringify(meetings));
  
  // sort the meetings based on start time
  meetingsCopy.sort((a,b) => {
...
// Analysis
// Sorting them take O(n log n) and going through each of them after takes O(n)
// so that resolves to O(n log n) time complexity and O(n) space complexity if 
// none of the meetings overlap
